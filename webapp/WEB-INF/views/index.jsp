...
<html>
<head>
<title>Stream插件上传文件-bootstrap样式</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link href="/SSMR/Resources/css/stream-v1.css" rel="stylesheet" type="text/css">
	...
	<div class="row clearfix">
		<div class="col-md-7 column">
			<div class="page-header">
			  <h1>Stream插件<small>文件上传到FTP服务器</small></h1>
			</div>
			...
			<div class="btn-toolbar" role="toolbar">
				...
				<div class="btn-group">
					<button type="button" class="btn btn-default" onclick="javascript:_t.disable();"><span class="glyphicon glyphicon-minus-sign"></span> 禁止选择</button>
...
<script type="text/javascript" src="/SSMR/Resources/js/stream-v1.js"></script>
