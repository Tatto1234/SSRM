...
(function(){
	...
	function Main(cfg){
		...
		this.config = {
			...
			swfURL : cfg.swfURL || "/SSMR/Resources/swf/FlashUploader.swf",
			tokenURL : cfg.tokenURL || "/SSMR/stream/gettoken",
			frmUploadURL : cfg.frmUploadURL || Browser.firefox ? "/SSMR/stream/streamUploadByForm;" + document.cookie : "/SSMR/stream/streamUploadByForm",
			uploadURL : cfg.uploadURL || "/SSMR/stream/streamUpload"
		};
		Parent.apply(this, arguments);
	}
